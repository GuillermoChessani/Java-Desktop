...
public class Prestamo {
    ...
    public Prestamo(int Folio, Date Fecha,  String Equipo, String NS, String DepartamentoPresta, String ResponsablePresta,  String DepartamentoSolicita, String ResponsableSolicita) {
        this.Folio = Folio;
        this.Fecha = Fecha;
